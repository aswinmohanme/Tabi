...
export const header = ({title, icon, iconType, onIconPress}) => {
  return(
    <Header
      ...
      centerComponent={<View style={{ width: Dimensions.get('window').width * 0.6, paddingBottom: 2 }}><Text style={{fontFamily: 'karla-bold', fontSize: 18, color:colors.txtColor}}>{title}</Text></View>}
